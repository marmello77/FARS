...
* filename A string with the full name of a file in CSV format. This function returns an error, if the file does not exist in the directory.
...
Dependencies: This function depends on readr::read_csv
